...
./build/bin/StartCern2016 -xml etc/ipbus_cern16_phase3.xml -mss 1024000
./build/bin/SyncStartCern2016 -xml etc/ipbus_cern16_phase3.xml
./build/bin/SyncRestartCern2016 -xml etc/ipbus_cern16_phase3.xml
